...
class ModelPlain(ModelBase):
    ...
    def optimize_parameters(self, current_step):
        ...
        self.netG_forward()
        output1 , output2, output3 = self.E
        print('ok1')
        G_loss = self.G_lossfn_weight * (self.G_lossfn(output1, self.H) + self.G_lossfn(output2, output3))
        G_loss.backward()
        print('ok2')
    ...
    def current_visuals(self, need_H=True):
        ...
        print(self.E[0])
        out_dict['E'] = self.E[0].detach()[0].float().cpu()
        if need_H:
    ...
    def current_results(self, need_H=True):
        ...
        out_dict['E'] = self.E[0].detach().float().cpu()
        if need_H:
